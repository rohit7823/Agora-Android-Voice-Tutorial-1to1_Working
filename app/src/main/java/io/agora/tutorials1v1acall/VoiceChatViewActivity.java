...
public class VoiceChatViewActivity extends AppCompatActivity {
    ...
    private static final String LOG_TAG = "voice_call";
    ...
    private final IRtcEngineEventHandler mRtcEventHandler = new IRtcEngineEventHandler() { // Tutorial Step 1
        ...
        public void onUserMuteAudio(final int uid, final boolean muted) { // Tutorial Step 6
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if(muted) {
                        showShortToast(uid+" muted audio");
                        //onRemoteUserVoiceMuted(uid, muted);
                    }
                    else {
                        showShortToast(uid+" unmute audio");
                    }
                }
            });
        }
        ...
        public void onJoinChannelSuccess(String s, int i, int i1) {
            ...
            Log.d(LOG_TAG, "Channel Joined "+s+i+i1);
        }
        ...
        public void onError(int i) {
            super.onError(i);
            Log.d(LOG_TAG, "Error: "+i);
        }

        @Override
        public void onConnectionStateChanged(int i, int i1) {
            Log.d(LOG_TAG, "Connection State: "+i+" "+i1);
    ...
    private void joinChannel() {
        ...
        mRtcEngine.joinChannel(accessToken, "voiceDemo", null, 7823);
